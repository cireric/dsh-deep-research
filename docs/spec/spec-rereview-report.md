# 复审报告 — `docs/spec/dsh-deep-research.md`（v2 设计文档包，第二轮；复审时名 deep-research-hybrid.md）

> 更名说明：复审对象文件现已更名为 `docs/spec/dsh-deep-research.md`，项目统一为独立包 `dsh-deep-research`；下文 R6/R7 等条目为历史处置记录，保留当时称谓。
